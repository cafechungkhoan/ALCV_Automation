...
> **Author / Tác giả**: ALCV Team

---

## 🔐 Security Notice / Lưu Ý Bảo Mật

**Sensitive information has been masked in this document.**  
**Thông tin nhạy cảm đã được mã hóa trong tài liệu này.**

To get actual values, check the script or contact the administrator.  
Để lấy giá trị thực, kiểm tra script hoặc liên hệ quản trị viên.

...
- **Primary**: Data processing team (handles the leads)
- **CC**: Managers & stakeholders (for visibility)
...
CONFIG = {
  ...
  SPAM_FILTER: {
    ...
    KEYWORDS: [
      ...
      // Test names (generic placeholders)
      'test person a', 'test person b', 'no name', 'unnamed',
      // Test phones (invalid patterns)
      '0000000000', '1111111111', '9999999999', 
      '0123456789', '0987654321', '1234567890',
      // Bot/Automation
      'bot', 'robot', 'automated', 'automation', 'crawler', 'scraper',
      // Profanity (blocked terms - details omitted)
      // ... profanity keywords ...
      // Suspicious
...
```
┌──────────────────────────────────────────────────────┐
│  [Brand] | Lead mới / 新規リード                     │
│  Sheet: Lead info • Cột: C                           │
├──────────────────────────────────────────────────────┤
│  #     │ Họ tên / お名前  │ SĐT / 電話  │ Leadcode  │
├──────────────────────────────────────────────────────┤
│  2(C2) │ Customer A       │ 09XXXXXXXX  │ ZL0001    │
│  3(C3) │ Customer B       │ 09XXXXXXXX  │ ZL0002    │
├──────────────────────────────────────────────────────┤
...
|---------|------|---------|--------|
| ZL Auto v1.0 | Dec 19, 2025 | Initial ZL-specific version | Hieu Le |
| ZL Auto v1.1 | Dec 29, 2025 | Documentation created | Hieu Le |
